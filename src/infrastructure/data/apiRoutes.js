import { host, asinDataKey, asinDataTestMode } from "../../utils/env";
// import App from "../../../App";
// const host = App.host;
...
module.exports = {
    ...
    getAmazonAsinData: (asin) => `${host}/Amazons/GetAmazonProduct?asin=${asin}&key=${asinDataKey}&testMode=${asinDataTestMode}`,
