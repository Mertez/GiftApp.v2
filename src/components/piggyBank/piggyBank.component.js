...
export const PiggyBank = ({ refreshing, onRefreshingFinished }) => {
      ...
      {piggyBank && (
        <>
          <PiggyBankContainer>
            <Row>
              <W50>
                <PiggyBankIcon source={require('../../../assets/piggybank1.png')} style={{ width: WidthPercent(40), marginLeft: 0 }} resizeMode='contain' />
              </W50>
              <W50>
